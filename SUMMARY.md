...
* [Починка SafetyNet](imp/safetynet-fix/README.md)
  ...
  * [v24.x: USF + Zygisk](imp/safetynet-fix/24-usf+zyg.md)
  * [v24.x: Zygisk + DenyList](imp/safetynet-fix/24-zyg+deny.md)
...
* [Перепрошив устройства](imp/flash/README.md)
  ...
  * [Перепрошив через MiFlash](imp/flash/flash-miflash.md)
  * [Полная прошивка MIUI](imp/flash/full-rom.md)
...
* [Использование автоустановщика recovery](inst/use-autoinstall-recovery.md)
* [Отключение бабл уведомлений](inst/off-bubbles.md)
* [Отключение рекламы \[DNS-сервер\]](inst/off-ad-with-dns.md)
* [Отключение рекомендаций в меню недавних](inst/off-recom-in-recent.md)
...
* [Установка суперобоев](inst/install-superwallpaper.md)
* [Установка MIUI Launcher](inst/install-miui-launcher.md)
* [Частичный скриншот](inst/partial-screenshot.md)
...
* [Системные разделы android](info/system-partitions-in-android.md)
...
* [Пояснение - система в r/w](info/sistem-r+w-is.md)
* [Пояснение - названия MIUI](info/code-miui.md)
* [Пояснение - дешифратор (DFE)?](info/dfe-is.md)
* [Пояснение - OC, TWRP, Magisk и прочее](info/oc+twrp+magisk+etc-is.md)

## 🗃 Репозиторий <a href="#repo" id="repo"></a>

* [Прошивки, firmware, GApps и прочее](repo/custom/README.md)
  * [Magisk](repo/custom/magisk-skachat.md)
